...
//  -La dieta ya no será única, sino que se guardará en una lista de dietas. Esta lista tendrá un nombre para poder ser recuperado. Será necesario cambiar el menú para gestionar esta lista. Ahora en ved de crear/reemplazar dieta lo que haremos será:
...
//    -Se agregará un apartado nuevo al menú de "Gestión de pacientes" con las siguientes funcionalidades:
...
public class Menu {
    public static void main(String[] args) {
        DietProgram2 program = new DietProgram2();
